 ...
 */
class FileContent: NSObject, NSSecureCoding, ObservableObject {
    ...
    required init?(coder: NSCoder) {
        ...
        self.configuration.cursorPosition = coder.decodeObject(of: NSNumber.self,
                                                               forKey: "cursorPosition")?.intValue ?? 0
        
        self.configuration.renderMode = coder.decodeObject(of: NSNumber.self,
                                                           forKey: "renderMode")?.intValue ?? 0
        
        self.configuration.displayMode = coder.decodeObject(of: NSNumber.self,
                                                            forKey: "displayMode")?.boolValue ?? false
        self.configuration.displayStyle = coder.decodeObject(of: NSNumber.self,
                                                             forKey: "displayStyle")?.boolValue ?? false
        
        self.configuration.lineToLine = coder.decodeObject(of: NSNumber.self,
                                                           forKey: "lineToLine")?.boolValue ?? false
        
        self.configuration.lockToBottom = coder.decodeObject(of: NSNumber.self,
                                                             forKey: "lockToBottom")?.boolValue ?? false
        self.configuration.lockToRight = coder.decodeObject(of: NSNumber.self,
                                                            forKey: "lockToRight")?.boolValue ?? false
        
        self.configuration.liveRender = coder.decodeObject(of: NSNumber.self,
                                                           forKey: "liveRender")?.boolValue ?? true
        
        self.configuration.renderError = coder.decodeObject(of: NSNumber.self,
                                                            forKey: "renderError")?.boolValue ?? true
        self.configuration.errorColorString = coder.decodeObject(of: NSString.self,
                                                                 forKey: "errorColorString")?.string ?? "CC0000"
        
        self.configuration.minLineThicknessEnabled = coder.decodeObject(of: NSNumber.self,
                                                                        forKey: "minLineThicknessEnabled")?.boolValue ?? false
        self.configuration.minLineThickness = coder.decodeObject(of: NSNumber.self,
                                                                 forKey: "minLineThickness")?.doubleValue ?? 0.04
        
        self.configuration.leftJustifyTags = coder.decodeObject(of: NSNumber.self,
                                                                forKey: "leftJustifyTags")?.boolValue ?? false
        
        self.configuration.sizeLimitEnabled = coder.decodeObject(of: NSNumber.self,
                                                                 forKey: "sizeLimitEnabled")?.boolValue ?? false
        self.configuration.sizeLimit = coder.decodeObject(of: NSNumber.self,
                                                          forKey: "sizeLimit")?.doubleValue ?? 500.0
        
        self.configuration.maxExpansionEnabled = coder.decodeObject(of: NSNumber.self,
                                                                    forKey: "maxExpansionEnabled")?.boolValue ?? false
        self.configuration.maxExpansion = coder.decodeObject(of: NSNumber.self,
                                                             forKey: "maxExpansion")?.doubleValue ?? 1000.0
        
        self.configuration.trustAllCommands = coder.decodeObject(of: NSNumber.self,
                                                                 forKey: "trustAllCommands")?.boolValue ?? false
        if let commandsArray = coder.decodeObject(of: [NSArray.self, NSNumber.self],
                                                  forKey: "trustedCommands") as? NSArray {
            if let array = Array(commandsArray) as? [NSNumber],
               array.count == self.configuration.trustedCommands.count {
        ...
        if let bookmarksArray = coder
            .decodeObject(of: [NSArray.self, NSDictionary.self, NSUUID.self, NSString.self, NSValue.self],
                ...
                for item in array {
                    if let dictionary = item as? [String : Any],
                       ...
                       let ranges = dictionary["ranges"] as? [NSRange] {
                        let bookmark = BookmarkEntry(id: id, name: name, unnamed: unnamed,
                                                     description: description, iconName: icon, ranges: ranges)
