...
class TextPlaceholder: NSTextAttachment {
    ...
    var placeholderString: String {
        return cell.attributedString.string
    }
    ...
    var cell: TextPlaceholderCell {
        return attachmentCell as! TextPlaceholderCell
    }
    ...
    func addAttribute(_ name: NSAttributedString.Key, value: Any) {
        cell.attributedString.addAttribute(name, value: value)
    }
    
    func removeAttribute(_ name: NSAttributedString.Key) {
        cell.attributedString.removeAttribute(name)
    }
