...
struct ConfigurationView: View {
    ...
    /**
     ...
     `ConfigurationView` makes changes to a configuration object via this reference.
     */
    @ObservedObject var config: Configuration
    
    /**
     An unowned reference to the editor view from which the `ConfigurationView` instance is presented.
     
     This reference is used to interact with the editor view.
     
     - Note: It does NOT retain the editor view object.
     */
    unowned var editor: EditorVC!
    
    /**
     Set this state property to `true` to notify `ConfigurationView` of user's request to save
     current configuration as the app's default configuration, which subsequently displays a
     confirmation alert.
    ...
    @ViewBuilder
    private var liveRenderOption: some View {
        GroupBox {
            HStack {
    ...
    @ViewBuilder
    private var renderingOptionsSection: some View {
        GroupBox {
            // Render Error
            Group {
                HStack {
